...
rsync --size-only -urvLhi ../choice-landscape/ /mnt/usb/task/choice-landscape/ --exclude .git --exclude results --exclude target --exclude .cljs_node_repl --exclude .cpcache "$@"
